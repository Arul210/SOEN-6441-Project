...
<html lang="en">
  ...
  <body>
        ...
        <div class="row justify-content-between gy-5">
          ...
          >
            ...
            <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
              <a href="#getting-started" class="btn-book-a-table"
                >Get Started >></a
              >
    ...
    <main id="main">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
              <div class="why-box">
                ...
                <p>
                  ...
                  <p>Use Foodfinder to find yummy recipes
      ...
      <section id="getting-started" class="book-a-table">
        <div class="container" data-aos="fade-up">
              ...
              >
                <div class="row gy-4 justify-content-center">
                  ...
                  >
                    ...
                    <option value="0-250">Under 250 kcalories</option>
                    <option value="250-500">250 - 500 kcalories</option>
                    <option value="500-750">500 - 750 kcalories</option>
                    <option value="750-1500">Above 750 kcalories</option>
                  </select>
                  <select
